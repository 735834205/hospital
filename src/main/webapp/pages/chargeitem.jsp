		  ...
		  columns: [
		  {
		    ...
		    title: '预约科室'
			  ...
			  formatter:function(value,row,index){
				  ...
				  var deleteButton = "<button onclick=\"myDeleteClick("+row.chargeid+")\" type=\"button\" class=\"btn btn-link\"><span class=\"glyphicon glyphicon-trash\" style=\"color: rgb(0, 0, 60); font-size: 17px;\"> </span></button>";				
		 ...
		 success:function(data){
			 //data：指后台查询后返回来的用户信息
			     $('#myUpdateModal').modal().on('shown.bs.modal',
			    	 ...
			    	 $("#updatechargetime").val(data.chargetime);
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  <form id="myAddForm" class="form-horizontal" action="">		  
					  ...
					  <div class="form-group">
					    <label id="chargetime-error" class="error" for="chargetime" style="margin-top: 4px;color: red;font-size: 15px;">预约时间:</label>
					    <div class="col-sm-10">
					      <input type="text"  name="chargetime" class="form-control" id="inputchargetime" placeholder="预约时间">
						  <script>
								laydate.render({
								  elem: '#inputchargetime' //指定元素
								  ,theme: 'molv'
								});
						  </script>
					    </div>
                      ...
                      <div class="form-group">
					    <label for="inputPassword3" class="col-sm-2 control-label">预约医师:</label>
					    <div class="col-sm-10">
					  ...
					  <div class="form-group">
					    <label for="inputPassword3" class="col-sm-2 control-label">预约科室:</label>
					    <div class="col-sm-10">
            ...
            <div class="modal-body">
                  ...
                  <form id="myUpdateForm" class="form-horizontal">
				    ...
				    <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <input type="text"  name="chargetime" class="form-control" id="updatechargetime" placeholder="预约时间">
						  <script>
								laydate.render({
