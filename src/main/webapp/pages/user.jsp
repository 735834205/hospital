...
$(function(){//jquery的加载事件
	$('#table').bootstrapTable({
		...
		$.ajax({
			type:'post',//提交方式
			url:'${pageContext.request.contextPath}/position/getPosition.action',//访问后台的地址   查询所有的岗位信息
...
function updateUser(){
	...
	$.ajax({
		type:'post',//提交方式
		url:'${pageContext.request.contextPath}/user/updateUserById.action',//修改的地址
		data:data,
		dataType:'json',
		success:function(data){
				//关闭修改模态框
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                  ...
                  <form id="myUpdateForm" class="form-horizontal">
					  ...
					  <div class="form-group">
					    <label for="inputPassword3" class="col-sm-2 control-label">所处科室:</label>
					    <div class="col-sm-7">
